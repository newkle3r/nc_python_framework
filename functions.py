...
def save_env_variables(env_vars):
    with open('/var/scripts/service-API/nc_python_framework/env_variables.json', 'w') as file:
        json.dump(env_vars, file, indent=4)

def get_env_variables():
    if os.path.exists('env_variables.json'):
        with open('/var/scripts/service-API/nc_python_framework/env_variables.json', 'r') as file:
